...
_Generated: 2026-08-17T11:21:56.946Z_
...
Workspace `mcp.json` _(folder: web system NQS)_

- **c:\Users\Asma\Desktop\web system NQS\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Asma\.claude.json** — _File exists — no servers defined_
