          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left text-sm">
              <thead className="bg-slate-950/80 text-xs uppercase text-slate-400">
                <tr>
                  {['Name', 'Username', 'Phone', 'District', 'Center', 'Type', 'Status', 'Password', 'Actions'].map((heading) => (
              ...
              <tbody className="divide-y divide-slate-800">
                {loading ? (
                  <tr><td colSpan="9" className="px-4 py-10 text-center text-slate-400">Loading operators...</td></tr>
                  ...
                  <tr key={operator._id} className="hover:bg-slate-800/50">
                    ...
                    <td className="px-4 py-3 text-slate-300">{operator.assignedDistrict || operator.center?.district || '--'}</td>
